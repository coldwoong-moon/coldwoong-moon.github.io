...
또한 사용자 정의 아이콘도 완전히 지원됩니다. 프로젝트 루트의 `assets/icons/` 디렉토리에 자체 SVG 아이콘 자산을 배치하기만 하면 됩니다. icons 디렉토리의 모든 아이콘은 테마 전반에서 사용할 수 있게 됩니다.

내장 아이콘의 전체 목록과 해당 이름은 아래에서 참조할 수 있습니다.
